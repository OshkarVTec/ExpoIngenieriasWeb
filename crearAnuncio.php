   ...
   <body>
      ...
      <table>
         ...
         <tr>
            ...
            <td><textarea type="text" id="title" name="anuncio" value="<?php echo !empty($name)?$name:'';?>"></textarea></td>            
         </tr>
...
<td><input type="text" id="link" name="poster" placeholder="Fecha: 00:00" value="<?php echo !empty($poster)?$poster:'';?>"></td>                
